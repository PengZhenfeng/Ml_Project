...
@interface MLWebScanViewController ()

@end

@implementation MLWebScanViewController
...
- (void)setUI {
    self.view.backgroundColor = MLColor_WhiteGray;
    [self setNavBar];
}
...
- (void)setNavBar {
    ...
    [rightbutton setTitle:@"浏览" forState:UIControlStateNormal];
